...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed w-full z-50 bg-white/50 ${isOpen ? '' : 'shadow-lg backdrop-blur-md'}`}>
      ...
      <div
        className={`md:hidden transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'max-h-screen animate-menu-open bg-white/50 backdrop-blur-md shadow-burger-open' : 'max-h-0 animate-menu-close'}`}
        id="mobile-menu"
      >
